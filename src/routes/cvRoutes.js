class CVRoutes {
  ...
  setupRoutes(app) {
      ...
      app.get('/api/cv/gcms', (req, res) => this.cvController.getGcmsApplicants(req, res));
      ...
      app.get('/api/cv/analytics/gcms', (req, res) => this.cvController.getGcmsAnalytics(req, res));
